...
Atenção: Verifique as bibliotecas necessárias já foram instaladas previamente. Comando library() ou na interface gráfica do RStudio - Packages
...
### 5.5 Verificar a normalidade dos resíduos
